...
<div class="ct-wrapper">
    ...
    <?php 
        // Thiết lập múi giờ Việt Nam để hiển thị đúng giờ
        date_default_timezone_set('Asia/Ho_Chi_Minh'); 
        
        // Kiểm tra nếu có ngày đặt thì mới hiển thị
        if(!empty($dh['ngay_dat']) && $dh['ngay_dat'] != '0000-00-00 00:00:00') {
            echo date('d/m/Y H:i', strtotime($dh['ngay_dat']));
        } else {
            echo "Vừa xong";
        }
    ?>
